...
2. api try out, this is supported api that you have created ex. \
    curl -X POST http://localhost:8080/api/sftu004/list

This vue application using `sftu004` api to manipulate transaction. \
...
### Testing
1. Normally copy output folder after build success ex. vftu004 into [vueserve](https://github.com/willsofts/vueserve) project under public path and then you can launch it directly ex. 

    http://localhost:8080/vftu004/vftu004.html
